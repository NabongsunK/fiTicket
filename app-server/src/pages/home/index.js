                      ...
                      <div className="row">
                        ...
                        <div className="col-lg-8 col-sm-7">
                          <div className="right-content">
                            ...
                            <ul className="info">
                              <li>
                                <i className="fa fa-user"></i> 8.66 Mil People
                              </li>
                              <li>
                                <i className="fa fa-globe"></i> 41.290 km2
                              </li>
                              <li>
                                <i className="fa fa-home"></i> $1.100.200
                              </li>
                            </ul>
                      ...
                      <div className="row">
                        ...
                        <div className="col-lg-8 col-sm-7">
                          <div className="right-content">
                            ...
                            <ul className="info">
                              <li>
                                <i className="fa fa-user"></i> 44.48 Mil People
                              </li>
                              <li>
                                <i className="fa fa-globe"></i> 275.400 km2
                              </li>
                              <li>
                                <i className="fa fa-home"></i> $946.000
                              </li>
                            </ul>
                            <div className="text-button">
                              <Link to="about.html">
                      ...
                      <div className="row">
                        ...
                        <div className="col-lg-8 col-sm-7">
                          <div className="right-content">
                            ...
                            <ul className="info">
                              <li>
                                <i className="fa fa-user"></i> 67.41 Mil People
                              </li>
                              <li>
                                <i className="fa fa-globe"></i> 551.500 km2
                              </li>
                              <li>
                                <i className="fa fa-home"></i> $425.600
                              </li>
                            </ul>
                            <div className="text-button">
                              <Link to="about.html">
